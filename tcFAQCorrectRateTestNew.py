...
# 测试数据excel路径
excelpath=os.getcwd()+'/test-data/faq测试集3.7.xlsx'  # taibaotestcasereduce.xlsx    faqdata.xlsx
# 测试结果路径
    ...
    def run(self):
        ...
        while len(questionsCollection) > 0:
            ...
            try:
                ...
                rlock.release()
            # 头信息
            header = {'Content-Type': 'application/json','sessionId': str(gl.getTimestamp()),'userId': str(gl.getTimestamp()),'appId': 'csbot',
                      }
